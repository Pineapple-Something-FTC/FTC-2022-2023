...
//        intakeThing(IN,2000);
        armThing(800, UP, speed, 2000);
//
        move(200, forward, speed,2500);
        turn(969, right, speed,2000);
        strafe(800, left, speed, 2000);

//        intakeThing(OUT,500);
//        intakeThing(NEUTRAL,0); (kinda sus)

        strafe(590, left, speed, 1000);
      //   armThing(100,DOWN,500,1500);
        move(1400, true, speed,1500);
