...
@Autonomous
public class AutoLeft11RED extends LinearOpMode {
...
// code for scoring in front
        ...
        turn((969 / 2 + 969 + 4 + 2 + 19 + 19 + 19 + 4 + 1), PineappleTag.left, 969, 2690);
        move(142, PineappleTag.forward, PineappleTag.speed, 690);
        intakeThing(PineappleTag.IN, 150);
        followLine(PineappleTag.RED, -699 - 6 - 9 - 4 - 2 - 69 - 19);
        ...
        move(PineappleTag.forwardSecondCone, PineappleTag.forward, 2000, 569);

        intakeThing(PineappleTag.OUT, 350);
        intakeThing(PineappleTag.NEUTRAL, 50);
        move(400 - 69 - 4 - 2 - 1, PineappleTag.back, 2000, 469);
        armThing(-(1), 1500, 10);
        ...
        if (bobot.tagOfInterest.id == PineappleTag.LEFT) {
            ...
            move(1869 + 42 - 2 - 4, PineappleTag.forward, 2000, 6690);
