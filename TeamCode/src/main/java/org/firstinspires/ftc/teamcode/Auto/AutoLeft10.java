...
@Autonomous
public class AutoLeft10 extends LinearOpMode {
...
// code for scoring in front
        ...
        armThing(-(1), 1500, 20);
        turn((969/2+969+4+2+19+19+19+4+1+19+19+19+9+4+2), bobot.left, 969, 2690);



        if(bobot.tagOfInterest.id==bobot.LEFT) {

            move(869-4-2, bobot.forward, 2000, 6690);

        }
        else if (bobot.tagOfInterest.id==bobot.RIGHT) {
            move(1069+19+4+42+19+2+1, bobot.back, 2000, 6690);

        }
        else {
            move(142, bobot.back, 2000, 6690);
        }
