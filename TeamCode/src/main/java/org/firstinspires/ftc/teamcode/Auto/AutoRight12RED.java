...
@Autonomous
public class AutoRight12RED extends PineappleTag {
    @Override
    public void runOpMode() {
        ...
        drive.turn(515, PineappleTag.left, 500, 2000);
        ...
        drive.turn((1537), PineappleTag.right, 1500, 1690);
        ...
        drive.turn(640, PineappleTag.right, 969, 969);
        ...
        drive.turn(711, PineappleTag.left, 2000, 690);
