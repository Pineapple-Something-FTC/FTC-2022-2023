...
// code for scoring in front
        ...
        turn(969 / 2 + 4 + 2 + 6 + 4 + 6 + 9, PineappleTag.left, 500, 2000);
        ...
        armThing(-(769), 1500, 0);
        turn((969 / 2 + 969 + 4 + 19 + 9 + 4 + 2 + 6 + 19 + 9 + 6 + 4 + 2), PineappleTag.right, 1500, 1690);
        move(420, PineappleTag.forward, PineappleTag.speed, 569);
        intakeThing(PineappleTag.IN, 0);
        followLine(PineappleTag.RED, -699 + 69 - 6 - 9 - 6 - 9 - 4 - 2 - 1 - 4 - 2 - 1 - 19 - 9);
        ...
        turn(420 + 69 + 69 + 9 + 42 + 6 + 9 + 7 + 2 + 4 + 2 + 1, PineappleTag.right, 969, 969);
        move(1496, PineappleTag.forward, 2000, 1069);
        intakeThing(PineappleTag.IN, 0);
        followLine(PineappleTag.RED, -469);
        ...
        armThing(-1, 2000, 0);
        turn(699 + 9 + 4 - 1, PineappleTag.left, 2000, 690);
