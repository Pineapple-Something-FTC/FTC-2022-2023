...
// code for scoring in front
        ...
        armThing(-(769), 1500, 0);
        turn((969/2+969+4+19+9+4+2+6+19+9+6+4+2 ), bobot.left, 1500, 1690);
        move(420, bobot.forward, bobot.speed, 569);
        intakeThing(bobot.IN, 0);
        followLine(bobot.BLUE, -699+69-6-9-6-9-4-2-1-4-2-1-19-9);
        ...
        turn((420+69+20+6+19+21+19+9+9+42+6+9+4+2+1), bobot.right, 2000, 769);
        ...
        turn(420+69+69+9+42+6+9+7+2+4+2+1, bobot.left, 969, 969);
        ...
        turn(699+19, bobot.left, 2000, 642);
        ...
        armThing(-1, 2000, 0);
        turn(699+9+4-1, bobot.right, 2000, 690);
