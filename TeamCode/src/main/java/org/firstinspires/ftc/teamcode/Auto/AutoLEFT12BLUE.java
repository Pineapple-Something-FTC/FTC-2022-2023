...
@Autonomous
public class AutoLEFT12BLUE extends PineappleTag {
    ...
    public void runOpMode() {
        ...
        drive.turn(515, PineappleTag.right, 500, 2000);
        ...
        drive.turn(656, PineappleTag.right, 2000, 769);
        drive.straight(390, PineappleTag.forward, 2000, 542);

        arm.intakeThing(PineappleTag.OUT, 250);
        arm.intakeThing(PineappleTag.NEUTRAL, 0);

        drive.straight(361, PineappleTag.back, 2000, 469);

        arm.armThing(-769, 1500, 10);

        drive.turn(640, PineappleTag.left, 969, 969);
        drive.straight(1496, PineappleTag.forward, 2000, 1069);

        arm.intakeThing(PineappleTag.IN, 0);

        drivePID.followLine(DrivePID.BLUE, -469);

        arm.armThing(-290, 1269, 542);
        arm.armThing(-1042, 1269, 742);

        drive.straight(869, PineappleTag.back, 2000, 869);
        drive.turn(718, PineappleTag.left, 2000, 642);
        drive.straight(229, PineappleTag.forward, 2000, 290);

        arm.intakeThing(PineappleTag.OUT, 250);
        arm.intakeThing(PineappleTag.NEUTRAL, 0);

        drive.straight(228, PineappleTag.back, 3000, 369);

        arm.armThing(-1, 2000, 0);

        drive.turn(711, PineappleTag.right, 2000, 690);
        ...
        if (tagOfInterest.id == PineappleTag.LEFT) {
            ...
            drive.straight(1269, PineappleTag.back, 3000, 6690);
        } else {
