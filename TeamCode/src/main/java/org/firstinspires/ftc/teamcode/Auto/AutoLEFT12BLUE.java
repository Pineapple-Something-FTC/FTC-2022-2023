...
@Autonomous
public class AutoLEFT12BLUE extends LinearOpMode {
...
// code for scoring in front
        ...
        turn(969 / 2 + 4 + 2 + 6 + 4 + 6 + 9, PineappleTag.right, 500, 2000);
        ...
        move(PineappleTag.backwardFirstCone - 19 - 2 - 1, PineappleTag.back, PineappleTag.speed, 699);
        armThing(-(769), 1500, 0);
        turn((969 / 2 + 969 + 4 + 19 + 9 + 4 + 2 + 6 + 19 + 9 + 6 + 4 + 2), PineappleTag.left, 1500, 1690);
        move(420, PineappleTag.forward, PineappleTag.speed, 569);
        intakeThing(PineappleTag.IN, 0);
        followLine(PineappleTag.BLUE, -699 + 69 - 6 - 9 - 6 - 9 - 4 - 2 - 1 - 4 - 2 - 1 - 19 - 9);

        armThing(-369, 1269, 569);
        armThing(-769, 1269, 742);

        move(2169, PineappleTag.back, 969, 2690);
        armThing(-2350, 1690, 569);
        turn((420 + 69 + 20 + 6 + 19 + 21 + 19 + 9 + 9 + 42 + 6 + 9 + 4 + 2 + 1), PineappleTag.right, 2000, 769);
        move(369 + 21, PineappleTag.forward, 2000, 542);

        intakeThing(PineappleTag.OUT, 250);
        intakeThing(PineappleTag.NEUTRAL, 0);
        move(400 - 48 + 21 + 9 - 21, PineappleTag.back, 2000, 469);
        armThing(-(769), 1500, 10);
        turn(420 + 69 + 69 + 9 + 42 + 6 + 9 + 7 + 2 + 4 + 2 + 1, PineappleTag.left, 969, 969);
        ...
        turn(699 + 19, PineappleTag.left, 2000, 642);
        move(296 - 69 + 2, PineappleTag.forward, 2000, 369 - 42 - 19 - 9 - 9);
        intakeThing(PineappleTag.OUT, 250);
        intakeThing(PineappleTag.NEUTRAL, 0);

        move(142 + 42 + 19 + 19 + 4 + 2, PineappleTag.back, 3000, 369);
        armThing(-1, 2000, 0);
        turn(699 + 9 + 4 - 1, PineappleTag.right, 2000, 690);
        ...
        if (bobot.tagOfInterest.id == PineappleTag.LEFT) {
            ...
            move(1269, PineappleTag.back, 3000, 6690);

        } else {

            move(269, PineappleTag.back, 3000, 6690);
