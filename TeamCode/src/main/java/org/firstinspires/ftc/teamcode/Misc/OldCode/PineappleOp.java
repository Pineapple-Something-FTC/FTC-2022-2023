    ...
    @Override public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.right_trigger > 0 || gamepad1.left_trigger > 0) {
                if((g.getCurrentPosition() < 300 && gamepad1.left_trigger > 0)
                        || (g.getCurrentPosition() > 1780 && gamepad1.right_trigger > 0)) {
...
//
//            // Telemetry
            telemetry.addData("Arm position", deeznuts.getVoltage());
