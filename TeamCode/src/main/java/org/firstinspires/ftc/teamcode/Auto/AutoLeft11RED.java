...
// code for scoring in front
        ...
        turn((969/2+969+4+2+19+19+19+4+1), bobot.left, 969, 2690);
        move(142, bobot.forward, bobot.speed, 690);
        intakeThing(bobot.IN, 150);
        followLine(bobot.RED, -699-6-9-4-2-69-19);
        ...
        intakeThing(bobot.NEUTRAL, 50);
        move(400-69-4-2-1, bobot.back, 2000, 469);
        armThing(-(1), 1500, 10);
        turn(420+69+69+9+42+4+2+1-23, bobot.left, 569, 1690);



        if(bobot.tagOfInterest.id==bobot.LEFT) {

            move(1869+42-2-4, bobot.forward, 2000, 6690);
