...
public class BlueBlueCones extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        resetEncoders();
        intakeThing(IN, 1500);
        armThing(842, UP, speed, 1600);

        move(200, forward, speed,1000);
        turn(942, left, speed, 1690);
        move(69, back, speed, 300);
        strafe(1821, right, speed, 2000);
        move(350,forward,speed,1000);
        armThing(769, UP, speed, 1000);
        intakeThing(OUT, 1000);
        intakeThing(NEUTRAL, 50);
        armThing(842, UP, speed, 1000);
        ...
        armThing(273, UP, speed, 1500);
        move(942, forward, speed, 1500);
        armThing(200, UP, speed, 300);
        intakeThing(IN, 1500);
        armThing(369, UP, speed, 1500);
        move(969, back, speed, 1500);
        armThing(842, UP, speed, 2000);
        turn(1542,right, speed, 2500);
        move(300, forward, speed, 1000);
        intakeThing(OUT, 1500);
        move(300, back, speed, 1000);
